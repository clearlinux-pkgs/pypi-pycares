...
Source0  : https://files.pythonhosted.org/packages/f5/37/4d4f8ac929e98aad64781f37d9429e82ba65372fc89da0473cdbecdbbb03/pycares-4.9.0.tar.gz
...
%prep
%setup -q -n pycares-4.9.0
cd %{_builddir}/pycares-4.9.0
pushd ..
cp -a pycares-4.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749825763
