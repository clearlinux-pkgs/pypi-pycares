...
Source0  : https://files.pythonhosted.org/packages/6c/ac/05e32fe0abecf98b58cb28646d59280ebad8d79b9785ad6771fa830a458b/pycares-4.6.0.tar.gz
...
%prep
%setup -q -n pycares-4.6.0
cd %{_builddir}/pycares-4.6.0
pushd ..
cp -a pycares-4.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744043466
