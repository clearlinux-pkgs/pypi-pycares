...
Source0  : https://files.pythonhosted.org/packages/47/2e/1fab7f91820c788a3d236f8fe25a1ea6c4f51b728fb11d3c05d02e04a5d4/pycares-4.6.1.tar.gz
...
%prep
%setup -q -n pycares-4.6.1
cd %{_builddir}/pycares-4.6.1
pushd ..
cp -a pycares-4.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745245445
